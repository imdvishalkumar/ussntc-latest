            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="footer-text" :class="footerTextClass" :style="{ color: footerTextColor }">
                    ...
                    <a href="https://fundraiserssports.com" target="_blank" class="pe-1"
                        ...
                        <img src="../assets/images/frs-logo.svg" alt="Vortex Legacy Group Logo" style="height: 16px;" />
                    </a>
                    ...
                    <router-link to="/privacy-policy" :style="{ color: footerTextColor }">Privacy Policy</router-link> |
                    <router-link to="/terms" :style="{ color: footerTextColor }">Terms</router-link> |
                    <router-link to="/refund-policy" :style="{ color: footerTextColor }">Refund Policy</router-link>
                </div>
