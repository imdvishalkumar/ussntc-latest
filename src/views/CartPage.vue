                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row mb-2">
                            <div class="col-6">
                                ...
                                <strong>{{ item.donationDescription === "Donation" ? item.donationDescription : item.productDescription }}</strong><br />
                                Price: {{ item.donationDescription === "Donation" ? formatPrice(item.price) : formatPrice(item.productPrice) }}
                            </div>
                            <div class="col-3 text-center">
                                <span>{{ item.qty }}</span>
                            </div>
                            <div class="col-3 text-end">
                                <strong>{{ item.donationDescription === "Donation" ? formatPrice(item.qty * item.price) : formatPrice(item.qty * item.productPrice) }}</strong>
                            </div>
                        </div>
