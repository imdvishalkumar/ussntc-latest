...
export default {
    ...
    setup() {
        ...
        const prepareResponse = () => {
            ...
            const { campaign_access_code, emailAssociated, donatingOption, partner_code, how_you_heard, buying_as, affiliate_code } = cartStore.marketing;
