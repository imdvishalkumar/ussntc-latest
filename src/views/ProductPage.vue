    ...
    <div class="container" v-if="product">
        <div class="box">
            ...
            <div>
                ...
                <div class="row">
                    <div v-for="(child , index ) in product.children" :key="child.item_id"
                        ...
                        <div class="w-100 d-flex flex-column h-100">
                            ...
                            <div class="d-flex flex-column flex-grow-1 justify-content-end">
                                ...
                                <div class="second-text-size">
                                <p class="mt-1 mb-0 "  v-if="index===0">This is in addition to the complimentary keepsake brick already part of your package.</p>
                                </div>
